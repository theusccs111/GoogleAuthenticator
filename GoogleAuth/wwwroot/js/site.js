...
function updateOtp() {
    ...
    var urlMostradaNoApp = "linkdositeaqui.com"

    $('#qrImg').attr('src', 'https://chart.googleapis.com/chart?chs=200x200&cht=qr&chl=200x200&chld=M|0&cht=qr&chl=otpauth://totp/' + urlMostradaNoApp + '%3Fsecret%3D' + $('#secret').val());
    $('#secretHex').text(key);
